...
export default function EnglishAuction() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold mb-2">English Auction</h2>
          <p className="text-slate-400">Bid on assets with increasing prices</p>
        </div>
      ...
      {view === 'setup' && <AuctionSetup type="english" onComplete={() => setView('list')} />}
      {view === 'list' && (
        <AuctionList
          type="english"
          onSelectAuction={(id) => {
